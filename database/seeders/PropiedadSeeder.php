...
class PropiedadSeeder extends Seeder
{
    public function run(): void
    {
        $propiedades = [
            ...
            [
                'arrendador_email' => 'test2@example.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Piso de Prueba Arrendador',
                ...
                'lat' => 39.8628,
                'lng' => -4.0273,
                'descripcion' => 'Propiedad de prueba para validar que todos los arrendadores tienen una.',
                'precio' => 600.00,
                'gastos' => json_encode(['agua' => 20, 'luz' => 30, 'comunidad' => 25]),
                'estado' => 'alquilada',
            ],
            // Inicio de las 14 nuevas propiedades (del 17 al 30)
            [
                'arrendador_email' => 'carlos@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Ático en Vigo',
                'direccion' => 'Calle Príncipe 5',
                'piso' => '6',
                'puerta' => 'B',
                'ciudad' => 'Vigo',
                'cp' => '36202',
                'lat' => 42.2328,
                'lng' => -8.7226,
                'descripcion' => 'Precioso ático en el centro de Vigo',
                'precio' => 950.00,
                'gastos' => json_encode(['agua' => 25, 'luz' => 45, 'comunidad' => 40]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'elena@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Piso Playa Gijón',
                'direccion' => 'Paseo del Muro 33',
                'piso' => '3',
                'puerta' => 'C',
                'ciudad' => 'Gijón',
                'cp' => '33202',
                'lat' => 43.5452,
                'lng' => -5.6601,
                'descripcion' => 'Piso frente a la playa de San Lorenzo',
                'precio' => 1100.00,
                'gastos' => json_encode(['agua' => 30, 'luz' => 50, 'comunidad' => 45]),
                'estado' => 'borrador',
            ],
            [
                'arrendador_email' => 'roberto.mora@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Chalet en Santander',
                ...
                'lat' => 43.4623,
                'lng' => -3.8099,
                'descripcion' => 'Amplio chalet a las afueras de Santander',
                'precio' => 1350.00,
                'gastos' => json_encode(['agua' => 35, 'luz' => 60, 'comunidad' => 0]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'roberto.diaz@email.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Piso Burgos',
                'direccion' => 'Calle de la Paloma 8',
                'piso' => '2',
                'puerta' => 'A',
                'ciudad' => 'Burgos',
                'cp' => '09001',
                'lat' => 42.3439,
                'lng' => -3.6969,
                'descripcion' => 'Piso acogedor cerca de la catedral',
                'precio' => 680.00,
                'gastos' => json_encode(['agua' => 20, 'luz' => 40, 'comunidad' => 25]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'arrendador@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Estudio Salamanca',
                'direccion' => 'Rúa Mayor 2',
                'piso' => '1',
                'puerta' => 'B',
                'ciudad' => 'Salamanca',
                'cp' => '37002',
                'lat' => 40.9634,
                'lng' => -5.6669,
                'descripcion' => 'Estudio ideal para estudiantes',
                'precio' => 500.00,
                'gastos' => json_encode(['agua' => 15, 'luz' => 30, 'comunidad' => 20]),
                'estado' => 'alquilada',
            ],
            [
                'arrendador_email' => 'test2@example.com',
                ...
                'lat' => 42.4664,
                'lng' => -2.4456,
                'descripcion' => 'Piso en la famosa calle del pincho',
                'precio' => 720.00,
                'gastos' => json_encode(['agua' => 25, 'luz' => 45, 'comunidad' => 30]),
                'estado' => 'inactiva',
            ],
            [
                'arrendador_email' => 'carlos@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Dúplex Vitoria',
                'direccion' => 'Calle Dato 21',
                'piso' => '4',
                'puerta' => 'A',
                'ciudad' => 'Vitoria',
                'cp' => '01001',
                'lat' => 42.8465,
                'lng' => -2.6716,
                'descripcion' => 'Moderno dúplex en el centro',
                'precio' => 1050.00,
                'gastos' => json_encode(['agua' => 30, 'luz' => 55, 'comunidad' => 40]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'elena@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Piso San Sebastián',
                ...
                'lat' => 43.3214,
                'lng' => -1.9863,
                'descripcion' => 'Piso histórico en la Parte Vieja',
                'precio' => 1450.00,
                'gastos' => json_encode(['agua' => 35, 'luz' => 60, 'comunidad' => 50]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'roberto.mora@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Apartamento Pamplona',
                'direccion' => 'Calle Estafeta 40',
                'piso' => '1',
                'puerta' => 'C',
                'ciudad' => 'Pamplona',
                'cp' => '31001',
                'lat' => 42.8168,
                'lng' => -1.6432,
                'descripcion' => 'Apartamento con balcones a la calle',
                'precio' => 850.00,
                'gastos' => json_encode(['agua' => 20, 'luz' => 40, 'comunidad' => 30]),
                'estado' => 'borrador',
            ],
            [
                'arrendador_email' => 'roberto.diaz@email.com',
                ...
                'lat' => 42.1408,
                'lng' => -0.4087,
                'descripcion' => 'Pamplio piso luminoso',
                'precio' => 620.00,
                'gastos' => json_encode(['agua' => 22, 'luz' => 38, 'comunidad' => 25]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'arrendador@spotstay.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Estudio Teruel',
                'direccion' => 'Plaza del Torico 1',
                'piso' => '2',
                'puerta' => 'A',
                'ciudad' => 'Teruel',
                'cp' => '44001',
                'lat' => 40.3426,
                'lng' => -1.1070,
                'descripcion' => 'Estudio en la plaza principal',
                'precio' => 480.00,
                'gastos' => json_encode(['agua' => 15, 'luz' => 25, 'comunidad' => 15]),
                'estado' => 'alquilada',
            ],
            [
                'arrendador_email' => 'test2@example.com',
                'gestor_email' => 'miguel@spotstay.com',
                'titulo' => 'Piso Cuenca',
                'direccion' => 'Calle Alfonso VIII 20',
                'piso' => '3',
                'puerta' => 'B',
                'ciudad' => 'Cuenca',
                'cp' => '16001',
                'lat' => 40.0704,
                'lng' => -2.1373,
                'descripcion' => 'Piso en el casco antiguo',
                'precio' => 550.00,
                'gastos' => json_encode(['agua' => 20, 'luz' => 35, 'comunidad' => 20]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'carlos@spotstay.com',
                ...
                'lat' => 41.7667,
                'lng' => -2.4667,
                'descripcion' => 'Piso céntrico y tranquilo',
                'precio' => 450.00,
                'gastos' => json_encode(['agua' => 18, 'luz' => 30, 'comunidad' => 15]),
                'estado' => 'publicada',
            ],
            [
                'arrendador_email' => 'elena@spotstay.com',
                ...
                'lat' => 40.9481,
                'lng' => -4.1184,
                'descripcion' => 'Piso con encanto cerca del Alcázar',
                'precio' => 600.00,
                'gastos' => json_encode(['agua' => 22, 'luz' => 38, 'comunidad' => 28]),
                'estado' => 'alquilada',
            ],
        ];
