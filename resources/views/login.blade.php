...
<body>
    <form class="form" method="POST">
        ...
        <div class="flex-row">
            <div>
                <input type="checkbox" id="recordar-dispositivo" name="remember">
                <label for="recordar-dispositivo">Recuérdame</label>
            </div>
        ...
        <p class="p">¿No tienes cuenta? <span class="span">Registrarse</span></p>
        <p class="p line">O con</p>

        <div class="flex-row">
            <a href="{{ route('auth.google') }}" class="btn google" style="text-decoration: none;">
                <svg version="1.1" width="20" id="Capa_Google" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
