<nav class="navegacion-horizontal">
    <div class="contenedor-nav">
        <ul class="lista-nav">
            ...
            <li><a href="{{ route('miembro.arrendador.formulario') }}" class="enlace-nav {{ request()->routeIs('miembro.arrendador.formulario') ? 'activo' : '' }}"><i class="bi bi-plus-circle"></i> Registra tus Propiedades</a></li>
