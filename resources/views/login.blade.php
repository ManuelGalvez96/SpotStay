        ...
        <div class="form-content">
            ...
            <form action="{{ route('login') }}" method="POST" id="form-login">
                ...
                <div class="input-wrapper">
                    <input type="email" id="email-login" name="email" placeholder="Email Corporativo" value="{{ old('email') }}">
                ...
                <button type="submit" id="boton-enviar" class="btn-submit btn-login-desabilitado" disabled>Iniciar Sesión</button>
                @if(session('status'))
